...
PARAMS = dict(
    epochs=400,
    exp_name="swin-128bg-feat12-longer",
    acc_batch_size=64,
    ...
    scheduler_params=dict(
        max_lr=3e-3, div_factor=10, final_div_factor=10, pct_start=0.05
    ),
    accelerator="gpu",
    devices=2,
    precision=16,
...
def loss_function(outputs, labels):
    loss_fn = DiceCELossLabelSmoothing(to_onehot_y=True, softmax=True, include_background=True)
